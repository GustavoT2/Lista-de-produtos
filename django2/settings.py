...
SECRET_KEY = 'django-insecure-s9@kl_y1b95i_)hw$cz+lw-ej0nx58@q2$hk@_us2@elhjr+l&'
...
STATIC_URL = '/static/'
STATIC_ROOT = str(BASE_DIR / "staticfiles")  # Corrigido
MEDIA_URL = 'media/'
...
EMAIL_PORT = '587'
EMAIL_USER_TLS = 'True'
EMAIL_HOST_PASSOWORD = 'sua-senha'
"""